...
<html>
<head>
<title>Egypt | Admin Dashboard</title>
		...
		<div class="four-grids">
			<a href="manage-users.php" target="_blank">
					<div class="col-md-4 four-grid">
						<div class="for-box four-agileits">
							<div class="icon">
...
$cnt3=$query3->rowCount();
	...
	<div class="four-grids">
			<div class="col-md-4 four-grid">
						<div class="for-box  four-agileinfo">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text">
...
$cnt1=$query1->rowCount();
		...
		<a href="manage-bookings.php" target="_blank">
		<div class="col-md-3 four-grid">
						<div class="for-box  four-wthree" style="color:#ffc107 !important">
							<div class="icon">
								<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
							</div>
							<div class="four-text">
